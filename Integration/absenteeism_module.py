...
# create the special class to use from here on to predict new data #
class absenteeism_model():
    ...
    # data file (*.csv) to preprocess it #
    def load_and_clean_data(self, data_file):
        ...
        # to preserve the code , we will add a column with 'NaN' strings #
        ...
        reason_type_4 = reason_columns.loc[:, 22:].max(1)
        ...
        # assign names to the 4 reason type columns note: there is a more universal version of this code, however the
        # following will best suit our current purposes
        ...
        df = df.drop(['Absenteeism Time in Hours'], 1)

        # drop the variables we decide we don't need
        df = df.drop(['Day of the Week', 'Daily Work Load Average', 'Distance to Work'], 1)
